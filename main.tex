...
\bibitem{c34}Zhu, B. (2010). SCADA-specific Intrusion Detection/Prevention Systems: A Survey and Taxonomy. Network, 1–16. Retrieved from https://www.truststc.org/conferences/10/CPSWeek/papers/scs1\_paper\_8.pdf
\bibitem{c35}Morris, T. Srivastava, A., Reaves, B., Gao, W., Pavurapu, K., Reddi, R. A Control System Testbed to Validate Critical Infrastructure Protection Concepts. International Journal of Critical Infrastructure Protection (2011). Elseiver. doi:10.1016/j.ijcip.2011.06.005
\bibitem{c36}Eibe Frank, Mark A. Hall, and Ian H. Witten (2016). The WEKA Workbench. Online Appendix for "Data Mining: Practical Machine Learning Tools and Techniques", Morgan Kaufmann, Fourth Edition, 2016.
\end{thebibliography}
